...
esposo(jorge, teresa_esposa).
esposa(edithM, alejandro).

padrede(jorge, esmeralda).
padrede(jorge, hugo).
padrede(jorge, nataly).
madrede(teresa_esposa, esmeralda).
madrede(teresa_esposa, hugo).
madrede(teresa_esposa, nataly).

padrede(alejandroM, alejandro_hijo).
padrede(alejandroM, alejandra).
...
padrede(alejandro, alejandrito).
padrede(alejandro, eleazar).
padrede(alejandro, kenia).
